...
export default function ProductComponent({product}) {
   ...
   return (
      <div className="relative flex w-full max-w-xs flex-col overflow-hidden rounded-2xl border border-neutral-500 shadow-lg transition-transform hover:scale-102 hover:shadow-xl">
